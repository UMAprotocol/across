...
const readClients = new Map<string,umaSDK.across.clients.bridgePool.ReadClient>()
function getReadClient(address:string):umaSDK.across.clients.bridgePool.ReadClient {
  if(readClients.has(address)) return readClients.get(address) as umaSDK.across.clients.bridgePool.ReadClient 
